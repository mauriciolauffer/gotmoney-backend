...
export function sendRecoveryPassword(sendToEmail: string, password: string, config: MailerConfig): Promise<any> {
...
export function sendNewUser(sendToEmail: string, password: string, config: MailerConfig): Promise<any> {
